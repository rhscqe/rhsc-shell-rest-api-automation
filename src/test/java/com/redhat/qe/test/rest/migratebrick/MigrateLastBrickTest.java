...
public class MigrateLastBrickTest extends MigrateTestBase{

	@Override
	protected Volume getVolumeToBeCreated() {
		return new VolumeFactory().distributed("startbriciikmigrate",4, getHost1(), getHost2());
	}
//	
//	@Override
...
//	
	...
	public void testRestStartedStatus(){
		...
		migrateAction.expect("(?i)cannot remove all.*bricks");
	}
