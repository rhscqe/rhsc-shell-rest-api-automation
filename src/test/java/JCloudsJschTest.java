...
//			}).start();
			 ...
			 shellStream.println("hi"); shellStream.flush();
//			 System.out.println("buffer:" + buffer.toString()); buffer.setLength(0);
			 String line;
			 while(fromChannel.ready() && (line = fromChannel.readLine()) != null){
					System.out.println("out" + line);
			 }
			 
			 
			 
//			 shellStream.println("hihihi"); shellStream.flush();Thread.sleep(1000);
//			 System.out.println("buffer:" + buffer.toString()); buffer.setLength(0);
